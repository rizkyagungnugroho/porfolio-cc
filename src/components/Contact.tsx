...
export default function ContactSection() {
  ...
  return (
    <section className="relative py-14 bg-gray-900 flex justify-center items-center min-h-screen">
      <div className="relative z-10 max-w-screen-md mx-auto px-4 text-gray-400 md:px-8 text-center">
        ...
        <form className="mt-12 max-w-lg mx-auto">
          ...
          <button type="submit" className="w-full mt-4 px-4 py-2 text-white bg-blue-600 hover:bg-blue-700 rounded-md">Submit</button>
        </form>
      </div>
    </section>
  );
